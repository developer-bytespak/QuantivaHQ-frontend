...
interface ComingSoonProps {
  title?: string;
  description?: string;
  icon?: "trade" | "insights" | "paper" | "pool" | "default";
}

export function ComingSoon({ 
  title = "Coming Soon", 
  description = "This feature is currently under development for stocks. Stay tuned!",
  icon = "default"
}: ComingSoonProps) {
  const getIcon = () => {
    switch (icon) {
      ...
      <div className="max-w-2xl w-full rounded-2xl shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_0_20px_rgba(252,79,2,0.08),0_0_30px_rgba(253,163,0,0.06)] bg-gradient-to-br from-white/[0.07] to-transparent p-12 backdrop-blur text-center">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-lg text-slate-400 max-w-md mx-auto leading-relaxed">{description}</p>
          </div>
