    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button
            onClick={onBack}
            className="rounded-lg border border-slate-700 bg-slate-800 p-2 text-white transition-colors hover:border-[#fc4f02]/50"
          >
        ...
        <div className="flex items-center gap-4">
          <button className="rounded-lg border border-slate-700 bg-slate-800 p-2 text-white transition-colors hover:border-[#fc4f02]/50">
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            ...
            className={`rounded-lg border border-slate-700 bg-slate-800 p-2 transition-colors hover:border-[#fc4f02]/50 ${
