          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {isLongDescription && (
              <button
                ...
                className="text-xs font-medium text-[var(--primary)] hover:text-[var(--primary-light)] transition-colors"
              >
                Read More
              </button>
            )}
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-white/10">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg bg-gradient-to-br from-[var(--primary)]/20 to-[var(--primary-light)]/20">
