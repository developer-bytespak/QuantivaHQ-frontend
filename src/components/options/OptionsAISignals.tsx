...
function SignalCard({ signal }: { signal: AiOptionsSignal }) {
  ...
  return (
    <div className="rounded-xl border border-white/[0.06] bg-[#12121a] p-4 transition-colors hover:border-white/[0.10]">
      ...
      {/* Strategy name */}
      <p className="mt-2 text-sm font-medium text-[#fc4f02]">
    ...
    return (
      <div className="flex min-h-[40vh] items-center justify-center">
        <div className="max-w-sm text-center">
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-[#fc4f02]/10">
            <svg className="h-6 w-6 text-[#fc4f02]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
