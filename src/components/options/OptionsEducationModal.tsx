  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        tag: "AI",
        tagColor: "bg-[var(--primary)]/15 text-[var(--primary)]",
      },
    ],
  },
];
      ...
      <div className="relative flex w-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-white/[0.08] bg-[#0e0e16] shadow-2xl sm:max-h-[85vh]">
          ...
          <div className="hidden w-52 flex-shrink-0 border-r border-[--color-border] bg-white/[0.01] p-3 sm:block">
            <nav className="space-y-1">
              {SECTIONS.map((s, i) => (
                ...
                >
                  <span className={activeSection === i ? "text-[var(--primary)]" : "text-slate-500"}>
                    {s.icon}
                  </span>
                  {s.title}
                </button>
        ...
        <div className="flex items-center justify-between border-t border-[--color-border] px-6 py-3.5">
          ...
          {isLast ? (
            <button
              onClick={onClose}
              className="rounded-lg bg-gradient-to-r from-[var(--primary)] to-[var(--primary-light)] px-5 py-2 text-xs font-semibold text-white transition-transform hover:scale-[1.02]"
            >
              Start Trading
            </button>
          ) : (
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-[var(--primary)]/10 px-4 py-2 text-xs font-semibold text-[var(--primary)] transition-colors hover:bg-[var(--primary)]/20"
            >
              Next
              <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
