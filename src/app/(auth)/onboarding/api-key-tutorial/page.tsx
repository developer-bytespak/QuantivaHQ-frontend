  ...
  return (
    ...
    >
      ...
      <div className="mb-3 flex items-start gap-3">
        {/* Circular badge */}
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[var(--primary)] to-[var(--primary-light)] text-xl font-bold text-white shadow-lg shadow-[rgba(var(--primary-rgb),0.3)]">
          {number}
        </div>
...
export default function ApiKeyTutorialPage() {
  ...
  const exchangeInfo = {
    ...
    alpaca: {
      ...
      gradient: "from-[#fcba03] to-[var(--primary-light)]",
      ...
      action: (
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-[var(--primary)] to-[var(--primary-light)] px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-[rgba(var(--primary-rgb),0.3)] transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-[rgba(var(--primary-rgb),0.4)]"
          >
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-lg border border-slate-700/50 bg-slate-800/50 p-3">
            ...
            <div className="space-y-2">
              ...
              {/* Step 3 */}
              <div className="flex items-center gap-2">
                <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[var(--primary)] to-[var(--primary-light)] text-xs font-semibold text-white shadow-md shadow-[rgba(var(--primary-rgb),0.3)]">
                  3
                </div>
                <div className="flex-1">
                  <p className="text-xs text-slate-300">Look for and click on <span className="font-semibold text-[var(--primary)]">"API Management"</span> in the settings menu</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="w-48 space-y-1.5">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex h-9 items-center rounded-lg bg-gradient-to-r from-[var(--primary)]/40 to-[var(--primary-light)]/40 border-2 border-[var(--primary)]/60 px-3 shadow-lg shadow-[rgba(var(--primary-rgb),0.3)]">
                    <div className="flex items-center gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-[var(--primary)] shadow-sm shadow-[rgba(var(--primary-rgb),0.3)]"></div>
                ...
                <div className="flex h-full items-center justify-center">
                  <div className="text-center">
                    <div className="mb-1.5 flex justify-center">
                      <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--primary)]/20 border-2 border-[var(--primary)]/40 shadow-lg shadow-[rgba(var(--primary-rgb),0.2)]">
          ...
          <div className="rounded-lg border border-slate-700/50 bg-slate-800/40 p-3">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                value="QuantivaHQ"
                readOnly
                className="flex-1 rounded-lg bg-slate-900/60 border border-slate-700/50 px-3 py-2 text-sm text-white outline-none focus:border-[var(--primary)]/50 focus:ring-1 focus:ring-[var(--primary)]/20"
              />
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-lg border border-slate-700/50 bg-slate-800/40 p-3 sm:p-3.5">
            ...
            <div className="flex items-center gap-2 rounded-lg border border-slate-700/50 bg-slate-900/60 px-2 sm:px-3 py-1.5 sm:py-2 overflow-x-auto">
              ...
              <button className="flex h-7 sm:h-8 w-7 sm:w-8 items-center justify-center rounded-lg bg-slate-800/60 border border-slate-700/50 text-[var(--primary)] transition-colors hover:bg-slate-700/60 hover:text-[var(--primary-light)] flex-shrink-0">
          ...
          {selectedExchange !== "ibkr" && (
            <div className="flex justify-center">
              <button
                ...
                className="group relative overflow-hidden rounded-xl bg-gradient-to-r from-[var(--primary)] to-[var(--primary-light)] px-8 py-3 text-base font-semibold text-white shadow-xl shadow-[rgba(var(--primary-rgb),0.3)] transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-[rgba(var(--primary-rgb),0.4)]"
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  Next: Enter API Keys
                  <svg className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
