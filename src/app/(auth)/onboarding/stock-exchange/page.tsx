...
function ExchangeCard({ name, description, logo, gradient, delay, onSelect }: ExchangeCardProps) {
    ...
    return (
        <button
            ...
            className="group relative overflow-hidden rounded-lg sm:rounded-xl border-2 border-[--color-border] bg-[--color-surface-alt]/60 backdrop-blur transition-all duration-300 p-5 sm:p-6 md:p-7 hover:border-[#fc4f02]/50 hover:shadow-2xl hover:shadow-[#fc4f02]/20 w-full max-w-lg sm:max-w-md mx-auto min-h-max"
