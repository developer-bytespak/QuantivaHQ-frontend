  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[11000] flex items-center justify-center p-4">
        <div className="w-full max-w-[75vw] h-[85vh] rounded-2xl border border-white/10 bg-gradient-to-b from-gray-800 to-black shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_0_20px_rgba(var(--primary-rgb),0.08)] overflow-hidden flex flex-col">
          {/* Header */}
            ...
            <div className="flex items-center justify-between gap-3 mb-3">
              <div className="flex-1">
                <h3 className="text-lg font-bold text-white flex items-center gap-2">
                  <span className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-[var(--primary)] to-[var(--primary-light)]">
