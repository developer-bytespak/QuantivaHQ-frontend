        ...
        <div className="bg-gradient-to-br from-[--color-surface-alt]/90 to-[--color-surface-alt]/70 backdrop-blur-xl border border-[--color-border] rounded-xl sm:rounded-2xl p-4 sm:p-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            <a
              ...
              className="bg-[--color-surface]/50 border border-[--color-border]/50 rounded-lg sm:rounded-xl p-4 sm:p-6 hover:border-[var(--primary)]/30 transition-all duration-200 group"
            >
              <svg className="w-6 sm:w-8 h-6 sm:h-8 text-[var(--primary)] mb-2 sm:mb-3 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-[--color-surface]/50 border border-[--color-border]/50 rounded-lg sm:rounded-xl p-4 sm:p-6">
              <svg className="w-6 sm:w-8 h-6 sm:h-8 text-[var(--primary)] mb-2 sm:mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="space-y-2 sm:space-y-3">
            {faqs.map((faq) => (
              <button
                ...
                className="w-full bg-[--color-surface]/50 border border-[--color-border]/50 rounded-lg sm:rounded-xl p-4 sm:p-6 hover:border-[var(--primary)]/30 transition-all duration-200 text-left group"
              >
                <div className="flex items-center justify-between gap-3">
                  <span className="text-base sm:text-lg font-semibold text-white group-hover:text-[var(--primary)] transition-colors">{faq.question}</span>
                  <svg
                    className="w-4 sm:w-5 h-4 sm:h-5 text-[var(--primary)] flex-shrink-0 transition-transform group-hover:translate-x-1"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
          ...
          >
            ...
            >
              ...
              <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                ...
                <button
                  onClick={() => setSelectedFAQ(null)}
                  className="rounded-lg p-2 text-slate-400 transition-colors hover:bg-[--color-surface] hover:text-white flex-shrink-0"
                  aria-label="Close"
                >
          ...
          <div className="space-y-3 sm:space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 sm:px-4 py-2 rounded-lg bg-[--color-surface] border border-[--color-border] text-white placeholder-slate-500 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/50"
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                className="w-full px-3 sm:px-4 py-2 rounded-lg bg-[--color-surface] border border-[--color-border] text-white placeholder-slate-500 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/50 resize-none"
                placeholder="Please describe your issue or question in detail..."
              />
            </div>
            <button
              onClick={handleSubmitContact}
              className="w-full sm:w-auto px-4 sm:px-6 py-2 rounded-lg bg-gradient-to-r from-[var(--primary)] to-[var(--primary-light)] text-white text-sm sm:text-base font-medium hover:from-[var(--primary-light)] hover:to-[var(--primary-light)] transition-all duration-200"
            >
              Send Message
            </button>
          </div>
