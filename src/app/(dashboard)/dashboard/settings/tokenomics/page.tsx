    ...
    <div className="space-y-6">
      ...
      <div className="group cursor-pointer rounded-2xl border border-[--color-border] bg-gradient-to-br from-[--color-surface-alt]/80 to-[--color-surface-alt]/60 p-12 backdrop-blur shadow-xl shadow-blue-900/10 transition-all duration-300 hover:border-[#fc4f02]/50 hover:shadow-2xl hover:shadow-[#fc4f02]/20 hover:scale-[1.02]">
        <div className="flex flex-col items-center justify-center text-center min-h-[400px]">
          {/* Icon */}
          <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-[#fc4f02]/20 to-[#fda300]/20 border border-[#fc4f02]/30">
            <svg
          ...
          {/* Heading */}
          <h2 className="mb-3 text-3xl font-bold text-white">Tokenomics</h2>

          {/* Coming Soon Text */}
          <p className="mb-2 text-5xl font-bold text-[#fc4f02]">Launching Soon</p>
