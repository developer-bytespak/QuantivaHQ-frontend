...
export default function AdminTokenomicsPage() {
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="group cursor-pointer rounded-lg sm:rounded-2xl border border-[--color-border] bg-gradient-to-br from-[--color-surface-alt]/80 to-[--color-surface-alt]/60 p-4 sm:p-8 md:p-12 backdrop-blur shadow-xl transition-all duration-300 hover:border-[#fc4f02]/50 hover:shadow-2xl hover:shadow-[#fc4f02]/20 hover:scale-[1.02]">
        <div className="flex flex-col items-center justify-center text-center min-h-[300px] sm:min-h-[400px]">
          <div className="mb-4 sm:mb-6 flex h-16 sm:h-20 w-16 sm:w-20 items-center justify-center rounded-full bg-gradient-to-br from-[#fc4f02]/20 to-[#fda300]/20 border border-[#fc4f02]/30">
            <svg className="h-8 sm:h-10 w-8 sm:w-10 text-[#fc4f02]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
