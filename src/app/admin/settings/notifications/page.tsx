...
const DEFAULT_SETTINGS: NotificationSetting[] = [
  { id: "email", label: "Email Notifications", description: "Receive admin and pool notifications via email", enabled: true },
  { id: "push", label: "Push Notifications", description: "Receive push notifications on your device", enabled: true },
  { id: "pools", label: "Pool Alerts", description: "Get notified about new pools, payments, and approvals", enabled: true },
  { id: "payments", label: "Payment Alerts", description: "Notifications when users make payments", enabled: true },
  { id: "security", label: "Security Alerts", description: "Important security and account updates", enabled: true },
];

const STORAGE_KEY = "quantivahq_admin_notification_settings";
      ...
      <div className="bg-gradient-to-br from-[--color-surface-alt]/90 to-[--color-surface-alt]/70 backdrop-blur-xl border border-[--color-border] rounded-xl sm:rounded-2xl p-4 sm:p-8 shadow-lg">
        ...
        <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg sm:rounded-xl">
          <div className="flex items-start gap-2 sm:gap-3">
            ...
            <div>
              <p className="text-xs sm:text-sm text-blue-300 font-medium mb-1">Admin notification preferences</p>
              <p className="text-xs text-blue-400/80">Changes are saved automatically to this device.</p>
            </div>
          </div>
        </div>
      </div>
